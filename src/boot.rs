...
use crate::config::plat::{BOOT_STACK_SIZE, CACHED_VIRT_OFFSET, UNCACHED_VIRT_OFFSET};
...
unsafe fn init_boot_page_table() {
    unsafe {
        ...
        // 0x9000_0000..0xd000_0000, VPWXGD, 1G block
...
const LA_CSR_DMW1: usize = 0x181; // DMWIN1
...
unsafe extern "C" fn _start() -> ! {
    core::arch::naked_asm!("
        ...
        uncached_virt_offset = const UNCACHED_VIRT_OFFSET,
        cached_virt_offset = const CACHED_VIRT_OFFSET,
        la_csr_dmwin0 = const LA_CSR_DMW0,
        la_csr_dmwin1 = const LA_CSR_DMW1,
